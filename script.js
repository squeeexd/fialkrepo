...
// //22.09.2025
// //работа с кругом выше

// function changecolor() {
//     document.documentElement.style.setProperty('--color', raduga[radugaIndex++])
//     if(radugaIndex==7){
//         radugaIndex=0
//     }
// }
// circle.addEventListener('click', changecolor)
// let raduga = ['red', 'orange', 'yellow', 'green', 'aqua', 'blue', 'purple']
// let radugaIndex=0
...
function moveSlider() {
    ...
    document.documentElement.style.setProperty('--sliderPos', `${-250*curSlide}px`)
